...
# ')
```
<p> The outer radius of each regions represents the amount of imports. The ribbons between the regions represent the trade exchanges, they are colored in the color of the region that imports the most. </p>
</body></html>
